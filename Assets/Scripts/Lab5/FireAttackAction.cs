...
public class FireAttackAction : Action
{
    ...
    public override void Act(StateController controller)
    {
        ...
        if (instantiatedPrefabsInScene.Length < maxPrefabInScene)
        {
            ...
            Vector3 marioPosition = controller.transform.position;
            Vector3 spawnOffset = marioFaceRight.Value ? new Vector3(1, 0, 0) : new Vector3(-1, 0, 0);
            GameObject x = Instantiate(attackPrefab, marioPosition + spawnOffset, Quaternion.identity);
