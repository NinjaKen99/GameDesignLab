...
public class MarioStateController : StateController
{
    ...
    public void Fire()
    {
        ...
        this.gameObject.GetComponent<AudioSource>().PlayOneShot(fireball);
    }
    ...
    {
        spriteRenderer = GetComponent<SpriteRenderer>();
        while (string.Equals(currentState.name, "InvincibleSmallMario", System.StringComparison.OrdinalIgnoreCase))
        {
